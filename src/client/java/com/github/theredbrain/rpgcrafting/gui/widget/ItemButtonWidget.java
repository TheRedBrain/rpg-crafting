package com.github.theredbrain.rpgcrafting.gui.widget;
...
public class ItemButtonWidget extends ButtonWidget {
	...
	ItemButtonWidget(int x, int y, int width, int height, ItemStack itemStack, PressAction onPress) {
		super(x, y, width, height, Text.empty(), onPress, DEFAULT_NARRATION_SUPPLIER);
		this.itemStack = itemStack;
	}

	public static Builder builder(ItemStack itemStack, PressAction onPress) {
	...
	public static class Builder {
		...
		public Builder(ItemStack itemStack, PressAction onPress) {
			this.itemStack = itemStack;
