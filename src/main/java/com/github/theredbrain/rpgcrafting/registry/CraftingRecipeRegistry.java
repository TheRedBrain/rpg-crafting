...
import com.github.theredbrain.rpgcrafting.data.CraftingRecipeHelper;
...
public class CraftingRecipeRegistry {
    ...
    public static void encodeRegistry() {
        ...
        if (RPGCrafting.serverConfig.show_debug_log) {
            RPGCrafting.LOGGER.info("Crafting Recipes registry loaded: " + json);
        }
        ...
        if (RPGCrafting.serverConfig.show_debug_log) {
            RPGCrafting.LOGGER.info("Encoded Crafting Recipes registry size (with package overhead): " + buffer.readableBytes()
    ...
    public static void decodeRegistry(PacketByteBuf buffer) {
        ...
        if (RPGCrafting.serverConfig.show_debug_log) {
            RPGCrafting.info("Decoded Crafting Recipes registry in " + chunkCount + " string chunks");
            RPGCrafting.info("Crafting Recipes registry received: " + json);
        }
        var gson = new Gson();
